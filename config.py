...
USE_BST      = True     # False → train on your MediaPipe data only
...
CLASS_WEIGHTS = [
    1.4,   # backhand_drive      (weakest,  ~59%)
    0.9,   # backhand_net_shot   (strongest, ~83%)
    1.2,   # forehand_clear      (~66%)
    1.1,   # forehand_drive      (~72%)
    1.0,   # forehand_lift       (~80%)
    1.2,   # forehand_net_shot   (~65%)
]
